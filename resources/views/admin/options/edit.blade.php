                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <select name="key" id="key" class="form-control">
                                    ...
                                    <option value="address_es" @if($option->key == 'address_es') selected @endif>Address ES</option>
                                    ...
                                    <option value="youtube" @if($option->key == 'telegram') selected @endif>Youtube</option>
                                </select>
                                @if($errors->has('key'))
