...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('aboutcompany.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="title_name_en" class="form-control" name="title_name_en">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="title_name_es" class="form-control" name="title_name_es">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="content_es" class="my-editor" id="content_es" cols="30" rows="10"></textarea>
